...
@section('title', 'Kategori Kegiatan Masjid')
...
<div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Daftar Kategori Kegiatan Masjid</h2>
    </div>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    <td class="px-6 py-4 font-medium text-gray-900">{{ $kat->id }}</td>
                    <td class="px-6 py-4">{{ $kat->nama }}</td>
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-center gap-4">
                            <a href="{{ route('dkm.kategori.kegiatanMasjid.edit', $kat->id) }}" class="font-medium text-blue-600 hover:underline" title="Edit">Edit</a>
                            ...
                            <form id="delete-form-{{ $kat->id }}" class="hidden" action="{{ route('dkm.kategori.kegiatanMasjid.destroy', $kat->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
                ...
                @empty
                <tr>
                    <td colspan="3" class="text-center py-4 text-gray-500">Belum ada kategori kegiatan.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
