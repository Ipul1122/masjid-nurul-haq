...
<div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Daftar Kategori Galeri</h2>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-center gap-4">
                            <a href="{{ route('dkm.kategori.galeri.edit', $item->id) }}" class="font-medium text-blue-600 hover:underline" title="Edit">Edit</a>
                            ...
                            <form id="delete-form-{{ $item->id }}" class="hidden" action="{{ route('dkm.kategori.galeri.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
                ...
                @empty
                <tr>
                    <td colspan="2" class="text-center py-4 text-gray-500">Belum ada kategori galeri.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
