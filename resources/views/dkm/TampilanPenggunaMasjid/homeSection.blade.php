...
<div class="bg-white p-6 rounded-lg shadow">
    ...
    <form action="{{ route('dkm.tampilanPenggunaMasjid.homeSection.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <p class="mt-1 text-sm text-gray-500">Anda bisa memilih lebih dari satu gambar.</p>
        </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        @forelse($images as $image)
            <div class="relative group">
                ...
                <img src="{{ Storage::url($image->image_path) }}" alt="Carousel Image" class="w-full h-40 object-cover rounded-lg">
