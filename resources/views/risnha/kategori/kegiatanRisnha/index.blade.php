...
@section('title', 'Manajemen Kategori Kegiatan Risnha')
...
<div class="container mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">
            Manajemen Kategori Kegiatan Risnha
        </h1>
        <a href="{{ route('risnha.kategori.kegiatanRisnha.create') }}" 
                    ...
                    @forelse($kategori as $key => $item)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('risnha.kategori.kegiatanRisnha.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                <form action="{{ route('risnha.kategori.kegiatanRisnha.destroy', $item->id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
