...
<div class="py-12 bg-gray-50">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6 mt-16">
            <a href="{{ route('index') }}" class="inline-flex items-center text-sm font-semibold text-gray-600 hover:text-gray-800">
                    ...
                    @if(isset($latestUpdates) && $latestUpdates->count() > 0)
                        <div class="space-y-4">
                            @foreach($latestUpdates as $update)
                                <a href="{{ route('konten.show', ['type' => $type, 'id' => $update->id]) }}" 
