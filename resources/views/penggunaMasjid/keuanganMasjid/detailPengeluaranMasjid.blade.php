...
<div class="bg-white p-6 rounded shadow">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold">Detail pengeluaran</h2>
    ...
    {{-- Filter Bulan & Tahun --}}
    <form method="GET" action="{{ route('penggunaMasjid.keuanganMasjid.detailPengeluaranMasjid') }}" class="mb-4 flex gap-2 items-center">
        ...
        <a href="{{ route('penggunaMasjid.keuanganMasjid.detailPengeluaranMasjid', []) }}" class="bg-gray-300 text-black px-4 py-2 rounded">Reset ke Bulan Ini</a>
    </form>
