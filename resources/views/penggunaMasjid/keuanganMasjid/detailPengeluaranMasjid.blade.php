...
@section('title', 'Detail Pengeluaran Masjid')
@section('content')
<div class="container mx-auto px-4 py-6 max-w-7xl">
    <!-- Header Section -->
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Detail Pengeluaran</h2>
        <p class="text-gray-600 text-sm mt-1">Lihat rincian Pengeluaran Masjid berdasarkan periode</p>
    </div>

    <!-- Filter Section -->
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form method="GET" action="{{ route('penggunaMasjid.keuanganMasjid.detailPengeluaranMasjid') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <!-- Dropdown Bulan -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Bulan</label>
                    <select name="bulan" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-red-500 focus:border-transparent transition">
                ...
                <div>
                    ...
                    <select name="tahun" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-red-500 focus:border-transparent transition">
                ...
                <div class="flex items-end gap-2">
                    <button type="submit" class="flex-1 bg-red-600 hover:bg-red-700 text-white px-4 py-2.5 rounded-lg font-medium transition duration-200 shadow-sm">
                        Filter
                    </button>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="hidden md:block overflow-x-auto">
            <table class="w-full">
                ...
                <tfoot>
                    <tr class="bg-gradient-to-r from-red-50 to-red-100 border-t-2 border-red-200">
                        <td colspan="2" class="px-6 py-4 text-sm font-bold text-gray-700 uppercase">
                            Total Pemasukkan
                        </td>
                        <td class="px-6 py-4 text-right text-lg font-bold text-red-700">
        ...
        <div class="md:hidden divide-y divide-gray-200">
            ...
            @if($pengeluarans->count() > 0)
                <div class="p-4 bg-gradient-to-r from-red-50 to-red-100 border-t-2 border-red-200">
                    <div class="flex justify-between items-center">
                        <span class="text-sm font-bold text-gray-700 uppercase">Total Pemasukkan</span>
                        <span class="text-lg font-bold text-red-700">Rp {{ number_format($totalPengeluaran, 0, ',', '.') }}</span>
                    </div>
                </div>
            @endif
        </div>
