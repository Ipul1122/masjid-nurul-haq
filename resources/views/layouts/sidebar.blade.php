                    ...
                    <div class="menu-submenu max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                        ...
                        <div class="ml-8 mt-2 mb-2 space-y-1">
                            <a href="{{ route('dkm.tampilanPenggunaMasjid.buktiDonasi.index') }}" class="block px-4 py-2 text-gray-600 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all duration-200">
                                {{-- Icon diubah menjadi 'history' untuk Sejarah --}}
                                <i class="fas fa-hand-holding-dollar w-4 h-4 mr-2"></i>
                                Donasi
                            </a>
                        </div>
                    </div>
...
{{-- 
                ...
                <a href="{{ route('dkm.tampilanPenggunaMasjid.visiMisi.index') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-700 transition-all duration-200 group">
                    <i class="fas fa-desktop w-5 h-5 mr-3 group-hover:text-emerald-600"></i>
